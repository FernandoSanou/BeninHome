            ...
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                if (isset($_POST['search']) && isset($_POST['recherche'])) {  ?>
                    ...
                    <form action="search.php" class=" d-flex flex-column flex-sm-row w-100 gap-2  justify-content-center" method="post">
                        ...
                        <input type="text" class=" inputsearch  col-lg-6 col-md-5 col-sm-6 p-2" id="search" name="recherche" placeholder="Recherche" value="<?php echo $_POST['recherche']; ?>">
                ...
                <?php        } else {    ?>
                    ...
                    <form action="search.php" class=" d-flex flex-column flex-sm-row w-100 gap-2  justify-content-center" method="post">
                        ...
                        <input type="text" class=" inputsearch  col-lg-6 col-md-5 col-sm-6 p-2" id="search" name="recherche" placeholder="Recherche">
                        <button id="send" class="btn btn-primary col-lg-3 col-md-2 col-sm-3 ml-lg-2 px-0" name="search">Rechercher</button>
                    </form>
                    </p>
                <?php        }
            ...
            while ($resultats = $requeteGetNotification->fetch()) {
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        ...
                        ?>
                            <img width="100%" height="225" src="<?php echo $resultGetThePrincipalImage['bin']; ?>" alt="images chambre à louer" class="principalImage">
                        <?php } else { ?>
